  ...
  return (
    ...
    >
      ...
      <StepCard stepNumber={1} title={<>¿Qué nos da el enunciado?</>} variant="explanation">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 mt-2">
          <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800">
            <CardContent className="p-3 space-y-1">
              ...
              <p className="text-sm text-muted-foreground">Los valores posibles de la <strong>variable X</strong> (filas de la tabla).</p>
              <p className="text-sm">En este ejercicio: <InlineMath math="x_i" /> = 1, 4, 5</p>
            </CardContent>
          </Card>
          <Card className="bg-emerald-50 dark:bg-emerald-950/20 border-emerald-200 dark:border-emerald-800">
            <CardContent className="p-3 space-y-1">
              ...
              <p className="text-sm text-muted-foreground">Los valores posibles de la <strong>variable Y</strong> (columnas de la tabla).</p>
              <p className="text-sm">En este ejercicio: <InlineMath math="y_j" /> = 1, 3, 6</p>
            </CardContent>
          </Card>
        ...
        <Card className="bg-amber-50 dark:bg-amber-950/20 border-amber-200 dark:border-amber-800 mt-3">
          <CardContent className="p-3 text-sm space-y-1">
            <p className="font-semibold text-amber-800 dark:text-amber-200">¿Qué nos pide el ejercicio?</p>
      ...
      <StepCard stepNumber={3} title="Distribución condicionada de X para Y = 3" variant="calculation">
        ...
        <p className="text-sm text-muted-foreground mb-2">Miramos solo la columna de Y = 3 (la columna central, resaltada en amarillo). Las frecuencias conjuntas son:</p>
        <div className="bg-yellow-50 dark:bg-yellow-950/20 rounded p-2 text-sm mb-3">
        ...
        <p className="text-sm text-muted-foreground mb-2">Dividimos cada frecuencia de la columna entre el total de esa columna (<InlineMath math="n_{\cdot 2}" /> = {marginalY[1]}), <strong>NO</strong> entre N = {totalN}:</p>
