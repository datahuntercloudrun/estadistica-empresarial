    ...
    >
      ...
      <StepCard stepNumber={1} title="Que vamos a aprender en este ejercicio?" variant="explanation">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-3">
          <Card className="bg-blue-50 border-blue-200">
            <CardContent className="p-3 space-y-1">
              <p className="font-semibold text-blue-800 text-xs">1. Tabla sin agrupar</p>
              <p className="text-[10px] text-muted-foreground">Cada valor diferente tiene su propia fila. Vemos exactamente cuantas veces aparece cada salario.</p>
            </CardContent>
          </Card>
          <Card className="bg-emerald-50 border-emerald-200">
            <CardContent className="p-3 space-y-1">
              <p className="font-semibold text-emerald-800 text-xs">2. Tabla agrupada</p>
              <p className="text-[10px] text-muted-foreground">Los valores se agrupan en intervalos (rangos). Se simplifica la tabla y se ven mejor los patrones generales.</p>
            </CardContent>
          </Card>
          <Card className="bg-violet-50 border-violet-200">
            <CardContent className="p-3 space-y-1">
              <p className="font-semibold text-violet-800 text-xs">3. Histograma</p>
              <p className="text-[10px] text-muted-foreground">Grafico de barras pegadas que muestra visualmente como se distribuyen los datos en los intervalos.</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="bg-amber-50 border-amber-200 mt-3">
          <CardContent className="p-3 text-xs space-y-1">
            <p className="font-semibold text-amber-800">Datos del problema</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <div className="bg-blue-50 rounded p-2 space-y-1">
                <div className="flex items-center gap-2">
                  <Badge className="bg-blue-200 text-blue-800 text-[10px]"><InlineMath math="x_i" /></Badge>
                  <p className="font-semibold text-xs text-blue-800">Valor del salario</p>
                </div>
                <p className="text-[10px] text-muted-foreground">Cada valor diferente que aparece en los datos: 19, 20, 21, ..., 30.</p>
              </div>
              <div className="bg-blue-50 rounded p-2 space-y-1">
                <div className="flex items-center gap-2">
                  <Badge className="bg-blue-200 text-blue-800 text-[10px]"><InlineMath math="n_i" /></Badge>
                  <p className="font-semibold text-xs text-blue-800">Frecuencia absoluta</p>
                </div>
                <p className="text-[10px] text-muted-foreground">Cuantas veces aparece ese valor. Ej: si el salario 26 aparece 10 veces, <InlineMath math="n_i" /> = 10.</p>
              </div>
              <div className="bg-emerald-50 rounded p-2 space-y-1">
                <div className="flex items-center gap-2">
                  <Badge className="bg-emerald-200 text-emerald-800 text-[10px]"><InlineMath math="f_i" /></Badge>
                  <p className="font-semibold text-xs text-emerald-800">Frecuencia relativa</p>
                </div>
                <p className="text-[10px] text-muted-foreground">Proporcion respecto al total: <InlineMath math="f_i = n_i / n" />. Indica que porcentaje de trabajadores cobra ese salario.</p>
              </div>
              <div className="bg-violet-50 rounded p-2 space-y-1">
                <div className="flex items-center gap-2">
                  <Badge className="bg-violet-200 text-violet-800 text-[10px]"><InlineMath math="N_i" /> y <InlineMath math="F_i" /></Badge>
                  <p className="font-semibold text-xs text-violet-800">Acumuladas</p>
                </div>
                <p className="text-[10px] text-muted-foreground"><InlineMath math="N_i" /> = cuantos trabajadores cobran ese salario <strong>o menos</strong>. <InlineMath math="F_i" /> = proporcion acumulada.</p>
              </div>
            </div>
          </CardContent>
        </Card>

        <Card className="bg-rose-50 border-rose-200 mt-2">
      ...
      <StepCard stepNumber={3} title="a) Distribucion sin agrupar" variant="calculation">
        ...
        <Card className="bg-blue-50 border-blue-200 mt-2">
          <CardContent className="p-3 text-xs space-y-2">
            <p className="font-semibold text-blue-800">Como interpretar esta tabla:</p>
            ...
            <div className="bg-white rounded p-2 mt-1">
              <p className="font-semibold text-blue-800">Lectura de <InlineMath math="F_i" /> (frecuencia relativa acumulada):</p>
      ...
      <StepCard stepNumber={4} title="Por que agrupamos si ya tenemos la tabla sin agrupar?" variant="explanation">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-2">
          <Card className="bg-blue-50 border-blue-200">
            <CardContent className="p-3 space-y-1">
              <p className="font-semibold text-blue-800 text-xs">Sin agrupar ({distinctValues.length} filas)</p>
              <p className="text-[10px] text-muted-foreground">Vemos el detalle exacto de cada salario. Util para datos con pocos valores distintos.</p>
              <p className="text-[10px] text-muted-foreground"><strong>Problema:</strong> con muchos valores distintos, la tabla seria enorme y dificil de interpretar.</p>
            </CardContent>
          </Card>
          <Card className="bg-emerald-50 border-emerald-200">
            <CardContent className="p-3 space-y-1">
              <p className="font-semibold text-emerald-800 text-xs">Agrupada ({groupedIntervals.length} filas)</p>
              <p className="text-[10px] text-muted-foreground">Vemos la tendencia general: donde se concentran los salarios. Mas facil de representar graficamente (histograma).</p>
              <p className="text-[10px] text-muted-foreground"><strong>Coste:</strong> perdemos el detalle de cada valor individual.</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="bg-amber-50 border-amber-200 mt-3">
          <CardContent className="p-3 text-xs space-y-2">
            <p className="font-semibold text-amber-800">Como se construyen los intervalos</p>
            ...
            <Card className="bg-white mt-2">
              <CardContent className="p-2 text-[10px] space-y-1">
                ...
                <p><Badge variant="outline" className="text-[10px] mr-1">[19, 21)</Badge> = incluye 19 y 20, pero <strong>no incluye 21</strong>. El corchete [ incluye el extremo, el parentesis ) lo excluye.</p>
                <p><Badge variant="outline" className="text-[10px] mr-1">[29, 31]</Badge> = el ultimo intervalo incluye ambos extremos para no dejar fuera el valor {maxVal}.</p>
      ...
      <StepCard stepNumber={5} title="Como se clasifican los datos en cada intervalo" variant="explanation">
        ...
        <Card className="bg-blue-50 border-blue-200 mt-2">
          <CardContent className="p-3 text-xs space-y-2">
            <p className="font-semibold text-blue-800 mb-2">Todos los intervalos con sus datos:</p>
            <div className="space-y-1.5">
              {intervalWithValues.map((d, i) => (
                <div key={i} className={`flex items-start gap-2 p-1.5 rounded ${d.values.length > 0 ? "bg-white" : "bg-gray-50 opacity-50"}`}>
                  <Badge variant="outline" className="text-[10px] shrink-0 mt-0.5 font-mono w-16 justify-center">
                    {d.label}
                  </Badge>
                  <div className="flex-1">
                    {d.values.length > 0 ? (
                      <span className="text-[10px] font-mono">{d.values.join(", ")}</span>
                    ) : (
                      <span className="text-[10px] text-muted-foreground italic">vacio</span>
                    )}
                  </div>
                  <Badge className={`text-[10px] shrink-0 ${d.values.length > 8 ? "bg-blue-200 text-blue-800" : d.values.length > 0 ? "bg-gray-200 text-gray-800" : "bg-gray-100 text-gray-400"}`}>
        ...
        <Card className="bg-amber-50 border-amber-200 mt-2">
          <CardContent className="p-3 text-xs space-y-1">
            <p className="font-semibold text-amber-800">Ejemplo concreto: intervalo [25, 27)</p>
            <p>Buscamos los datos que cumplen: 25 ≤ x &lt; 27. Los valores 25 y 26 caben, pero el 27 no (porque el parentesis ) lo excluye).</p>
            <p className="font-mono bg-white rounded p-1.5 text-[10px] mt-1">
      ...
      <StepCard stepNumber={6} title="a) Distribucion agrupada en intervalos de amplitud 2" variant="calculation">
        ...
        <Card className="bg-blue-50 border-blue-200 mt-2">
          <CardContent className="p-3 text-xs space-y-2">
            <p className="font-semibold text-blue-800">Como leer esta tabla:</p>
            <div className="space-y-1">
            ...
            <div className="bg-white rounded p-2 mt-1">
              <p className="font-semibold text-blue-800">Comparacion con la tabla sin agrupar:</p>
      ...
      <StepCard stepNumber={7} title="Que es un histograma y por que lo usamos aqui?" variant="explanation">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-2">
          <Card className="bg-violet-50 border-violet-200">
            <CardContent className="p-3 space-y-1">
              <p className="font-semibold text-violet-800 text-xs">Eje X (horizontal)</p>
              <p className="text-[10px] text-muted-foreground">Los <strong>intervalos</strong> de salario. Cada barra cubre un rango de 2 unidades. Estan en orden y son consecutivos.</p>
            </CardContent>
          </Card>
          <Card className="bg-violet-50 border-violet-200">
            <CardContent className="p-3 space-y-1">
              <p className="font-semibold text-violet-800 text-xs">Eje Y (vertical)</p>
              <p className="text-[10px] text-muted-foreground">La <strong>frecuencia absoluta</strong> (<InlineMath math="n_i" />). La altura de cada barra indica cuantos trabajadores hay en ese intervalo.</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="bg-amber-50 border-amber-200 mt-3">
          <CardContent className="p-3 text-xs space-y-2">
            <p className="font-semibold text-amber-800">Por que un histograma y no un diagrama de barras?</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-1">
              <div className="bg-white rounded p-2 space-y-0.5">
                <p className="font-semibold text-xs">Diagrama de barras</p>
                <p className="text-[10px] text-muted-foreground">Barras <strong>separadas</strong>. Para variables cualitativas o cuantitativas discretas (valores aislados).</p>
              </div>
              <div className="bg-white rounded p-2 space-y-0.5">
                <p className="font-semibold text-xs">Histograma</p>
                <p className="text-[10px] text-muted-foreground">Barras <strong>pegadas</strong>. Para datos agrupados en intervalos. Refleja que los intervalos son consecutivos (no hay &quot;huecos&quot;).</p>
              </div>
            </div>
      ...
      <StepCard stepNumber={8} title="b) Histograma de salarios diarios" variant="result">
        ...
        <Card className="bg-blue-50 border-blue-200 mt-3">
          <CardContent className="p-3 text-xs space-y-2">
            <p className="font-semibold text-blue-800">Interpretacion del histograma:</p>
            <div className="space-y-1.5">
              <div className="flex items-start gap-2">
                <Badge className="bg-blue-200 text-blue-800 text-[10px] shrink-0">Concentracion</Badge>
              ...
              <div className="flex items-start gap-2">
                <Badge className="bg-emerald-200 text-emerald-800 text-[10px] shrink-0">Forma</Badge>
              ...
              <div className="flex items-start gap-2">
                <Badge className="bg-violet-200 text-violet-800 text-[10px] shrink-0">Extremos</Badge>
        ...
        <Card className="bg-amber-50 border-amber-200 mt-2">
          <CardContent className="p-3 text-xs space-y-1">
            <p className="font-semibold text-amber-800">Conclusion practica</p>
      ...
      <StepCard stepNumber={9} title="Resumen: que hemos aprendido?" variant="result">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
          <Card className="bg-blue-50 border-blue-200">
            <CardContent className="p-3 space-y-1">
              <p className="font-semibold text-blue-800">Tabla sin agrupar</p>
          ...
          <Card className="bg-emerald-50 border-emerald-200">
            <CardContent className="p-3 space-y-1">
              <p className="font-semibold text-emerald-800">Tabla agrupada</p>
          ...
          <Card className="bg-violet-50 border-violet-200">
            <CardContent className="p-3 space-y-1">
              <p className="font-semibold text-violet-800">Histograma</p>
          ...
          <Card className="bg-amber-50 border-amber-200">
            <CardContent className="p-3 space-y-1">
              <p className="font-semibold text-amber-800">4 frecuencias</p>
