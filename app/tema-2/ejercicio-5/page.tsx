...
const classifications = [
  { num: 1, tipo: "Diagrama de sectores", variable: "Cualitativa Nominal", color: "bg-emerald-100 text-emerald-800", reason: "Círculo dividido en porciones proporcionales. Representa categorías (ciudades) sin orden natural. Adecuado porque tiene pocas categorías (4)." },
  { num: 2, tipo: "Cartograma (mapa coroplético)", variable: "Datos geográficos", color: "bg-cyan-100 text-cyan-800", reason: "Mapa donde cada zona se colorea según la intensidad del dato. Muestra la distribución espacial de una variable (densidad de población)." },
  { num: 3, tipo: "Diagrama de sectores (mal uso)", variable: "Cualitativa Nominal", color: "bg-rose-100 text-rose-800", reason: "Es un diagrama de sectores, pero con demasiadas categorías (12). Es difícil distinguir las porciones → no recomendado. Mejor usar un diagrama de barras." },
  { num: 4, tipo: "Diagrama de barras apilado", variable: "Cualitativa / Discreta", color: "bg-violet-100 text-violet-800", reason: "Barras divididas en segmentos que muestran la composición de cada categoría. Permite ver tanto el total como las partes." },
  { num: 5, tipo: "Diagrama de barras agrupado", variable: "Cualitativa / Discreta", color: "bg-violet-100 text-violet-800", reason: "Barras separadas agrupadas por categoría. Facilita la comparación directa entre grupos para cada categoría." },
  { num: 6, tipo: "Histograma + Polígono de frecuencias", variable: "Cuantitativa Continua", color: "bg-amber-100 text-amber-800", reason: "Rectángulos adyacentes (sin huecos) = histograma. La línea que conecta los puntos medios = polígono de frecuencias. Datos agrupados en intervalos." },
  { num: 7, tipo: "Pictograma", variable: "Cualitativa / Discreta", color: "bg-pink-100 text-pink-800", reason: "Usa figuras (cohetes) cuyo tamaño o cantidad es proporcional al dato. Muy visual e intuitivo, pero poco preciso." },
  { num: 8, tipo: "Diagrama de caja y bigotes (boxplot)", variable: "Cuantitativa", color: "bg-amber-100 text-amber-800", reason: "Resume la distribución con 5 valores (mín, Q1, mediana, Q3, máx) y muestra outliers (los dos puntos por encima del bigote superior)." },
  { num: 9, tipo: "Diagrama de dispersión", variable: "Bivariante Cuantitativa", color: "bg-orange-100 text-orange-800", reason: "Cada punto representa un par (X, Y). La nube ascendente indica correlación positiva entre las dos variables." },
  { num: 10, tipo: "Diagrama de dispersión con recta de regresión", variable: "Bivariante Cuantitativa", color: "bg-orange-100 text-orange-800", reason: "Igual que el anterior, pero incluye la recta de regresión (línea roja) que resume la tendencia lineal de los datos." },
];
  ...
  return (
    ...
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Card className="border-2">
            <CardContent className="p-3">
              <Badge className="bg-gray-200 text-gray-800 mb-2">Gráfico 1</Badge>
          ...
          <Card className="border-2">
            <CardContent className="p-3">
              <Badge className="bg-gray-200 text-gray-800 mb-2">Gráfico 2</Badge>
              <p className="text-[10px] font-semibold text-center mb-2">Densidad de población en España</p>
              <div className="grid grid-cols-5 gap-0.5 max-w-[240px] mx-auto">
                {/* Fila 1: Norte */}
                <div className="bg-orange-200 rounded text-[7px] p-1.5 text-center font-medium">GAL</div>
                <div className="bg-orange-200 rounded text-[7px] p-1.5 text-center font-medium">AST</div>
                <div className="bg-orange-300 rounded text-[7px] p-1.5 text-center font-medium">CANT</div>
                <div className="bg-orange-500 rounded text-[7px] p-1.5 text-center font-medium text-white">PV</div>
                <div></div>
                {/* Fila 2 */}
                <div className="bg-orange-100 rounded text-[7px] p-1.5 text-center font-medium col-span-2">C. Y LEÓN</div>
                <div className="bg-orange-200 rounded text-[7px] p-1.5 text-center font-medium">NAV</div>
                <div className="bg-orange-100 rounded text-[7px] p-1.5 text-center font-medium">ARAG</div>
                <div></div>
                {/* Fila 3 */}
                <div className="bg-orange-100 rounded text-[7px] p-1.5 text-center font-medium">EXT</div>
                <div className="bg-orange-700 rounded text-[7px] p-1.5 text-center font-bold text-white">MAD</div>
                <div className="bg-orange-100 rounded text-[7px] p-1.5 text-center font-medium">CLM</div>
                <div className="bg-orange-200 rounded text-[7px] p-1.5 text-center font-medium">ARAG</div>
                <div className="bg-orange-500 rounded text-[7px] p-1.5 text-center font-medium text-white">CAT</div>
                {/* Fila 4 */}
                <div className="bg-orange-300 rounded text-[7px] p-1.5 text-center font-medium col-span-2">ANDALUCÍA</div>
                <div className="bg-orange-300 rounded text-[7px] p-1.5 text-center font-medium">MUR</div>
                <div className="bg-orange-400 rounded text-[7px] p-1.5 text-center font-medium text-white">VAL</div>
                <div></div>
              </div>
              <div className="flex items-center gap-1 justify-center mt-3 text-[8px] text-muted-foreground">
                <span>Menor</span>
                <div className="w-4 h-2.5 bg-orange-100 rounded"></div>
                <div className="w-4 h-2.5 bg-orange-200 rounded"></div>
                <div className="w-4 h-2.5 bg-orange-300 rounded"></div>
          ...
          <Card className="border-2">
            <CardContent className="p-3">
              <Badge className="bg-gray-200 text-gray-800 mb-2">Gráfico 3</Badge>
          ...
          <Card className="border-2">
            <CardContent className="p-3">
              <Badge className="bg-gray-200 text-gray-800 mb-2">Gráfico 4</Badge>
              <ResponsiveContainer width="100%" height={220}>
          ...
          <Card className="border-2">
            <CardContent className="p-3">
              <Badge className="bg-gray-200 text-gray-800 mb-2">Gráfico 5</Badge>
              <ResponsiveContainer width="100%" height={220}>
                <BarChart data={barGroupData} margin={{ top: 10, right: 20, left: 10, bottom: 5 }}>
                  <CartesianGrid strokeDasharray="3 3" opacity={0.3} />
                  <XAxis dataKey="name" tick={{ fontSize: 12 }} />
          ...
          <Card className="border-2">
            <CardContent className="p-3">
              <Badge className="bg-gray-200 text-gray-800 mb-2">Gráfico 6</Badge>
              <ResponsiveContainer width="100%" height={220}>
          ...
          <Card className="border-2">
            <CardContent className="p-3">
              <Badge className="bg-gray-200 text-gray-800 mb-2">Gráfico 7</Badge>
              <p className="text-xs font-semibold text-center mb-2">Lanzamientos espaciales</p>
              <div className="space-y-1.5">
                {rocketData.map((d) => (
                  <div key={d.country} className="flex items-center gap-2">
                    <span className="w-12 text-[10px] text-right font-medium shrink-0">{d.country}</span>
                    ...
                    <span className="text-xs font-bold text-gray-700 shrink-0">{d.launches}</span>
                  </div>
                ))}
              </div>
          ...
          <Card className="border-2">
            <CardContent className="p-3">
              <Badge className="bg-gray-200 text-gray-800 mb-2">Gráfico 8</Badge>
              <BoxPlot
                min={0}
                q1={20}
                median={35}
          ...
          <Card className="border-2">
            <CardContent className="p-3">
              <Badge className="bg-gray-200 text-gray-800 mb-2">Gráfico 9</Badge>
              <ResponsiveContainer width="100%" height={220}>
          ...
          <Card className="border-2">
            <CardContent className="p-3">
              <Badge className="bg-gray-200 text-gray-800 mb-2">Gráfico 10</Badge>
              <ResponsiveContainer width="100%" height={220}>
                <ScatterChart margin={{ top: 10, right: 20, bottom: 20, left: 10 }}>
                  <CartesianGrid strokeDasharray="3 3" opacity={0.3} />
                  <XAxis
      ...
      <StepCard stepNumber={2} title="¿Para qué sirven los gráficos estadísticos?" variant="explanation">
        ...
        <Card className="bg-amber-50 border-amber-200 mt-2">
          <CardContent className="p-3 text-xs space-y-1">
            <p className="font-semibold text-amber-800">Regla fundamental: el tipo de gráfico depende del tipo de variable</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-2">
              <div className="bg-white rounded p-2">
                <p className="font-semibold text-emerald-700">Cualitativas</p>
                <p className="text-[10px] text-muted-foreground">Categorías sin escala numérica → gráficos que muestran proporciones o conteos por categoría</p>
              </div>
              <div className="bg-white rounded p-2">
                <p className="font-semibold text-blue-700">Cuantitativas</p>
                <p className="text-[10px] text-muted-foreground">Valores numéricos con escala → gráficos que reflejan la escala y la distribución de los datos</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-2">
          <Card className="bg-emerald-50 border-emerald-200">
            <CardContent className="p-4 space-y-2">
              ...
              <Badge variant="outline" className="text-xs">Cualitativas / Discretas con pocos valores</Badge>
              <p className="text-xs text-muted-foreground">Círculo dividido en &quot;porciones&quot; (sectores). Cada porción representa una categoría y su tamaño es proporcional a la frecuencia relativa.</p>
          ...
          <Card className="bg-violet-50 border-violet-200">
            <CardContent className="p-4 space-y-2">
              ...
              <Badge variant="outline" className="text-xs">Cualitativas / Discretas</Badge>
              <p className="text-xs text-muted-foreground">Barras verticales u horizontales cuya <strong>altura</strong> (o longitud) es proporcional a la frecuencia de cada categoría o valor.</p>
              <Card className="bg-white">
                <CardContent className="p-2 text-[10px] space-y-1">
          ...
          <Card className="bg-pink-50 border-pink-200">
            <CardContent className="p-4 space-y-2">
              ...
              <Badge variant="outline" className="text-xs">Cualitativas / Discretas</Badge>
              <p className="text-xs text-muted-foreground">Usa <strong>figuras o símbolos</strong> (personas, coches, monedas...) para representar los datos. El número o tamaño de los símbolos es proporcional a la frecuencia.</p>
              <Card className="bg-white">
                <CardContent className="p-2 text-[10px] space-y-1">
          ...
          <Card className="bg-blue-50 border-blue-200">
            <CardContent className="p-4 space-y-2">
              ...
              <Badge variant="outline" className="text-xs">Datos geográficos</Badge>
              <p className="text-xs text-muted-foreground">Mapa donde cada <strong>región se colorea</strong> según la intensidad del dato que representa (más oscuro = valor más alto).</p>
              <Card className="bg-white">
                <CardContent className="p-2 text-[10px] space-y-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-2">
          <Card className="bg-amber-50 border-amber-200">
            <CardContent className="p-4 space-y-2">
              ...
              <Badge variant="outline" className="text-xs">Cuantitativas continuas (datos agrupados)</Badge>
              <p className="text-xs text-muted-foreground">Rectángulos <strong>adyacentes sin separación</strong> donde el eje X muestra los intervalos y el <strong>área</strong> de cada rectángulo es proporcional a la frecuencia.</p>
              <Card className="bg-white">
                <CardContent className="p-2 text-[10px] space-y-1">
          ...
          <Card className="bg-teal-50 border-teal-200">
            <CardContent className="p-4 space-y-2">
              ...
              <Badge variant="outline" className="text-xs">Cuantitativas (agrupadas o no)</Badge>
              <p className="text-xs text-muted-foreground">Línea que une los <strong>puntos medios</strong> (marcas de clase) de las barras superiores de un histograma o diagrama de barras.</p>
              <Card className="bg-white">
                <CardContent className="p-2 text-[10px] space-y-1">
          ...
          <Card className="bg-cyan-50 border-cyan-200">
            <CardContent className="p-4 space-y-2">
              ...
              <Badge variant="outline" className="text-xs">Cuantitativas</Badge>
              <p className="text-xs text-muted-foreground">Resume la distribución en <strong>5 valores clave</strong> y permite detectar valores atípicos de un vistazo.</p>
              <Card className="bg-white">
                <CardContent className="p-2 text-[10px] space-y-1">
                  <p><strong>Los 5 valores:</strong></p>
                  <div className="flex gap-1 flex-wrap">
                    <Badge className="bg-cyan-100 text-cyan-800 text-[9px]">Mínimo</Badge>
                    <Badge className="bg-cyan-100 text-cyan-800 text-[9px]">Q1 (25%)</Badge>
                    <Badge className="bg-cyan-200 text-cyan-900 text-[9px]">Mediana (50%)</Badge>
                    <Badge className="bg-cyan-100 text-cyan-800 text-[9px]">Q3 (75%)</Badge>
                    <Badge className="bg-cyan-100 text-cyan-800 text-[9px]">Máximo</Badge>
                  </div>
          ...
          <Card className="bg-orange-50 border-orange-200">
            <CardContent className="p-4 space-y-2">
              ...
              <Badge variant="outline" className="text-xs">Variables bivariantes cuantitativas</Badge>
              <p className="text-xs text-muted-foreground">Cada observación es un <strong>punto en un plano</strong> con coordenadas (X, Y). Muestra si existe relación entre dos variables.</p>
              <Card className="bg-white">
                <CardContent className="p-2 text-[10px] space-y-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-2">
              <Card className="bg-white border-violet-200">
                <CardContent className="p-3 space-y-1">
                  ...
                  <div className="bg-violet-50 rounded p-1.5 mt-1">
                    <p className="text-[10px] text-muted-foreground"><strong>→ Gráficos 4 y 5:</strong> Barras separadas, categorías A-E.</p>
                  </div>
                </CardContent>
              </Card>
              <Card className="bg-white border-amber-200">
                <CardContent className="p-3 space-y-1">
                  <p className="font-semibold text-amber-800 text-sm">Histograma</p>
                  <div className="space-y-0.5 text-[10px]">
                  ...
                  <div className="bg-amber-50 rounded p-1.5 mt-1">
                    <p className="text-[10px] text-muted-foreground"><strong>→ Gráfico 6:</strong> Barras pegadas, intervalos de hectáreas.</p>
                  </div>
                </CardContent>
              </Card>
            </div>
      ...
      <StepCard stepNumber={6} title="Clasificación de cada gráfico" variant="result">
        <p className="text-xs text-muted-foreground mb-3">Aplicamos la teoría a cada uno de los 10 gráficos del enunciado:</p>
        <div className="space-y-3">
          {classifications.map((c) => (
            <div key={c.num} className="flex items-start gap-3 p-3 rounded-lg bg-gray-50 border">
              <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-gray-200 text-xs font-bold">
                {c.num}
              </span>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr className="border-t">
                <td className="p-3"><Badge className="bg-emerald-100 text-emerald-800">Cualitativa Nominal</Badge></td>
                <td className="p-3 text-xs">Sectores, barras, pictograma</td>
                <td className="p-3 text-[10px] text-muted-foreground hidden md:table-cell">Las barras se pueden reordenar</td>
              </tr>
              <tr className="border-t">
                <td className="p-3"><Badge className="bg-lime-100 text-lime-800">Cualitativa Ordinal</Badge></td>
                <td className="p-3 text-xs">Barras (respetando el orden)</td>
                <td className="p-3 text-[10px] text-muted-foreground hidden md:table-cell">El orden de las barras importa</td>
              </tr>
              <tr className="border-t">
                <td className="p-3"><Badge className="bg-blue-100 text-blue-800">Cuantitativa Discreta</Badge></td>
                <td className="p-3 text-xs">Barras, polígono de frecuencias</td>
                <td className="p-3 text-[10px] text-muted-foreground hidden md:table-cell">Barras separadas (valores aislados)</td>
              </tr>
              <tr className="border-t">
                <td className="p-3"><Badge className="bg-violet-100 text-violet-800">Cuantitativa Continua</Badge></td>
                <td className="p-3 text-xs">Histograma, polígono, boxplot</td>
                <td className="p-3 text-[10px] text-muted-foreground hidden md:table-cell">Barras pegadas (intervalos consecutivos)</td>
              </tr>
              <tr className="border-t">
                <td className="p-3"><Badge className="bg-orange-100 text-orange-800">Bivariante</Badge></td>
                <td className="p-3 text-xs">Diagrama de dispersión</td>
                <td className="p-3 text-[10px] text-muted-foreground hidden md:table-cell">Un punto por cada par (X, Y)</td>
              </tr>
              <tr className="border-t">
                <td className="p-3"><Badge className="bg-cyan-100 text-cyan-800">Geográfica</Badge></td>
                <td className="p-3 text-xs">Cartograma (mapa coroplético)</td>
                <td className="p-3 text-[10px] text-muted-foreground hidden md:table-cell">Colores por regiones</td>
              </tr>
            </tbody>
          </table>
        </Card>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 mt-3 text-xs">
          <Card className="bg-blue-50 border-blue-200">
            <CardContent className="p-2 space-y-1">
              ...
              <p className="text-muted-foreground text-[10px]">Boxplots (uno por grupo) o polígonos de frecuencias superpuestos.</p>
            </CardContent>
          </Card>
          <Card className="bg-emerald-50 border-emerald-200">
            <CardContent className="p-2 space-y-1">
              <p className="font-semibold text-emerald-800">Ver proporciones</p>
              <p className="text-muted-foreground text-[10px]">Diagrama de sectores (pocas categorías) o barras apiladas (muchas).</p>
            </CardContent>
          </Card>
          <Card className="bg-orange-50 border-orange-200">
            <CardContent className="p-2 space-y-1">
              <p className="font-semibold text-orange-800">Ver relación entre 2 variables</p>
              <p className="text-muted-foreground text-[10px]">Diagrama de dispersión. Si hay relación, los puntos forman un patrón.</p>
            </CardContent>
          </Card>
        </div>
      </StepCard>
