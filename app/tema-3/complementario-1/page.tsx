    ...
    <ExerciseLayout
      ...
      statement={
        <div className="space-y-2">
          ...
          <p className="font-mono text-sm bg-white dark:bg-gray-900 p-2 rounded">{rawData.join(", ")}</p>
    ...
    >
      ...
      <StepCard stepNumber={1} title="¿Qué vamos a aprender en este ejercicio?" variant="explanation">
        ...
        <Card className="bg-amber-50 dark:bg-amber-950/20 border-amber-200 dark:border-amber-800 mt-2 mb-3">
          <CardContent className="p-3 text-sm space-y-2">
            <p className="font-semibold text-amber-800 dark:text-amber-200">Nota sobre las unidades</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 mt-2">
          <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800">
            <CardContent className="p-3 space-y-1">
              <Badge className="bg-blue-200 dark:bg-blue-800/40 text-blue-800 dark:text-blue-200 text-sm">Mediana</Badge>
              <p className="text-sm text-muted-foreground">El valor del &quot;trabajador del medio&quot;. Divide la muestra en dos mitades iguales.</p>
            </CardContent>
          </Card>
          <Card className="bg-emerald-50 dark:bg-emerald-950/20 border-emerald-200 dark:border-emerald-800">
            <CardContent className="p-3 space-y-1">
              <Badge className="bg-emerald-200 dark:bg-emerald-800/40 text-emerald-800 dark:text-emerald-200 text-sm">Moda</Badge>
              <p className="text-sm text-muted-foreground">El salario más frecuente. &quot;¿Cuánto cobra la mayoría?&quot;</p>
            </CardContent>
          </Card>
          <Card className="bg-violet-50 dark:bg-violet-950/20 border-violet-200 dark:border-violet-800">
            <CardContent className="p-3 space-y-1">
              <Badge className="bg-violet-200 dark:bg-violet-800/40 text-violet-800 dark:text-violet-200 text-sm">Media</Badge>
              <p className="text-sm text-muted-foreground">El promedio clásico. Reparte el total equitativamente entre todos.</p>
            </CardContent>
          </Card>
          <Card className="bg-rose-50 dark:bg-rose-950/20 border-rose-200 dark:border-rose-800">
            <CardContent className="p-3 space-y-1">
              <Badge className="bg-rose-200 dark:bg-rose-800/40 text-rose-800 dark:text-rose-200 text-sm">Varianza y desv. típica</Badge>
              <p className="text-sm text-muted-foreground">¿Los salarios son parecidos entre sí o hay mucha diferencia?</p>
            </CardContent>
          </Card>
          <Card className="bg-amber-50 dark:bg-amber-950/20 border-amber-200 dark:border-amber-800">
            <CardContent className="p-3 space-y-1">
              <Badge className="bg-amber-200 dark:bg-amber-800/40 text-amber-800 dark:text-amber-200 text-sm">Cuartiles y deciles</Badge>
              <p className="text-sm text-muted-foreground">Puntos de corte que dividen los datos en partes iguales (4 o 10 partes).</p>
            </CardContent>
          </Card>
        </div>
      </StepCard>
      ...
      <StepCard stepNumber={2} title="Organizar los datos: tabla de frecuencias" variant="calculation">
        <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800 mb-3">
          <CardContent className="p-3 text-sm space-y-2">
            <p className="font-semibold text-blue-800 dark:text-blue-200">¿Por qué necesitamos una tabla de frecuencias?</p>
            <p className="text-muted-foreground">
            ...
            <div className="bg-white dark:bg-gray-900 rounded p-2 space-y-1 mt-1">
        ...
        <Card className="bg-amber-50 dark:bg-amber-950/20 border-amber-200 dark:border-amber-800 mt-3">
          <CardContent className="p-2 text-sm space-y-1">
            <p className="font-semibold text-amber-800 dark:text-amber-200">¿Qué nos dice esta tabla a simple vista?</p>
            <p className="text-muted-foreground">
      ...
      <StepCard stepNumber={3} title="Visualización: diagrama de barras" variant="explanation">
        <Card className="bg-violet-50 dark:bg-violet-950/20 border-violet-200 dark:border-violet-800 mb-3">
          <CardContent className="p-3 text-sm space-y-2">
            <p className="font-semibold text-violet-800 dark:text-violet-200">¿Por qué un gráfico de barras?</p>
            <p className="text-muted-foreground">
      ...
      <StepCard stepNumber={4} title="a) Mediana" variant="calculation">
        <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800 mb-3">
          <CardContent className="p-3 text-sm space-y-2">
            <p className="font-semibold text-blue-800 dark:text-blue-200">¿Qué es la mediana y para qué sirve?</p>
            <p className="text-muted-foreground">
        ...
        <Card className="bg-emerald-50 dark:bg-emerald-950/20 border-emerald-200 dark:border-emerald-800 mb-3">
          <CardContent className="p-3 text-sm space-y-2">
            <p className="font-semibold text-emerald-800 dark:text-emerald-200">Cálculo paso a paso</p>
            <p className="text-muted-foreground">
      ...
      <StepCard stepNumber={5} title="b) Moda" variant="calculation">
        <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800 mb-3">
          <CardContent className="p-3 text-sm space-y-2">
            <p className="font-semibold text-blue-800 dark:text-blue-200">¿Qué es la moda?</p>
            <p className="text-muted-foreground">
        ...
        <Card className="bg-emerald-50 dark:bg-emerald-950/20 border-emerald-200 dark:border-emerald-800 mb-3">
          <CardContent className="p-3 text-sm space-y-2">
            <p className="font-semibold text-emerald-800 dark:text-emerald-200">Identificación</p>
            <p className="text-muted-foreground">
      ...
      <StepCard stepNumber={6} title="c) Salario medio" variant="calculation">
        <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800 mb-3">
          <CardContent className="p-3 text-sm space-y-2">
            <p className="font-semibold text-blue-800 dark:text-blue-200">¿Qué es la media aritmética y qué pregunta responde?</p>
            <p className="text-muted-foreground">
        ...
        <Card className="bg-emerald-50 dark:bg-emerald-950/20 border-emerald-200 dark:border-emerald-800 mb-3">
          <CardContent className="p-3 text-sm space-y-2">
            <p className="font-semibold text-emerald-800 dark:text-emerald-200">Cálculo</p>
            <p className="text-muted-foreground">
      ...
      <StepCard stepNumber={7} title="d) Varianza y desviación típica" variant="calculation">
        <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800 mb-3">
          <CardContent className="p-3 text-sm space-y-2">
            <p className="font-semibold text-blue-800 dark:text-blue-200">¿Qué miden la varianza y la desviación típica?</p>
            <p className="text-muted-foreground">
        ...
        <Card className="bg-violet-50 dark:bg-violet-950/20 border-violet-200 dark:border-violet-800 mb-3">
          <CardContent className="p-3 text-sm space-y-2">
            <p className="font-semibold text-violet-800 dark:text-violet-200">Las fórmulas explicadas paso a paso</p>
            <div className="bg-white dark:bg-gray-900 rounded p-2 space-y-2">
              <div>
      ...
      <StepCard stepNumber={8} title="e) Primer cuartil y segundo decil" variant="calculation">
        <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800 mb-3">
          <CardContent className="p-3 text-sm space-y-2">
            <p className="font-semibold text-blue-800 dark:text-blue-200">¿Qué son los cuartiles y los deciles?</p>
            <p className="text-muted-foreground">
        ...
        <Card className="bg-violet-50 dark:bg-violet-950/20 border-violet-200 dark:border-violet-800 mb-3">
          <CardContent className="p-3 text-sm space-y-2">
            <p className="font-semibold text-violet-800 dark:text-violet-200">¿Cómo se calcula la posición?</p>
            <p className="text-muted-foreground">
        ...
        <Card className="bg-emerald-50 dark:bg-emerald-950/20 border-emerald-200 dark:border-emerald-800 mb-3">
          <CardContent className="p-3 text-sm space-y-2">
            <p className="font-semibold text-emerald-800 dark:text-emerald-200">Cálculo del primer cuartil (Q₁)</p>
        ...
        <Card className="bg-emerald-50 dark:bg-emerald-950/20 border-emerald-200 dark:border-emerald-800 mb-3">
          <CardContent className="p-3 text-sm space-y-2">
            <p className="font-semibold text-emerald-800 dark:text-emerald-200">Cálculo del segundo decil (D₂)</p>
      ...
      <StepCard stepNumber={9} title="Diagrama de caja (Boxplot)" variant="explanation">
        <Card className="bg-violet-50 dark:bg-violet-950/20 border-violet-200 dark:border-violet-800 mb-3">
          <CardContent className="p-3 text-sm space-y-2">
            <p className="font-semibold text-violet-800 dark:text-violet-200">¿Qué es un diagrama de caja y cómo se lee?</p>
            <p className="text-muted-foreground">
        ...
        <Card className="bg-amber-50 dark:bg-amber-950/20 border-amber-200 dark:border-amber-800 mt-3">
          <CardContent className="p-2 text-sm space-y-1">
            <p className="font-semibold text-amber-800 dark:text-amber-200">Lectura del boxplot</p>
            <p className="text-muted-foreground">
      ...
      <StepCard stepNumber={10} title="Resumen: ¿qué hemos aprendido de estos salarios?" variant="result">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800">
            <CardContent className="p-3 space-y-1">
              <Badge className="bg-blue-200 dark:bg-blue-800/40 text-blue-800 dark:text-blue-200 text-sm">Posición central</Badge>
          ...
          <Card className="bg-emerald-50 dark:bg-emerald-950/20 border-emerald-200 dark:border-emerald-800">
            <CardContent className="p-3 space-y-1">
              <Badge className="bg-emerald-200 dark:bg-emerald-800/40 text-emerald-800 dark:text-emerald-200 text-sm">Dispersión</Badge>
              <p className="text-sm text-muted-foreground">
          ...
          <Card className="bg-violet-50 dark:bg-violet-950/20 border-violet-200 dark:border-violet-800">
            <CardContent className="p-3 space-y-1">
              <Badge className="bg-violet-200 dark:bg-violet-800/40 text-violet-800 dark:text-violet-200 text-sm">Posición (cuartiles)</Badge>
              <p className="text-sm text-muted-foreground">
          ...
          <Card className="bg-rose-50 dark:bg-rose-950/20 border-rose-200 dark:border-rose-800">
            <CardContent className="p-3 space-y-1">
              <Badge className="bg-rose-200 dark:bg-rose-800/40 text-rose-800 dark:text-rose-200 text-sm">Rango salarial</Badge>
              <p className="text-sm text-muted-foreground">
