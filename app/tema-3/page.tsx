    ...
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-2">
          <Badge className="bg-violet-100 text-violet-800">Tema 3</Badge>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
        <Card className="border-l-4 border-l-blue-500 bg-blue-50/50">
          <CardContent className="p-4 space-y-1">
            <p className="font-bold text-blue-800 flex items-center gap-2"><Target className="h-5 w-5" /> ¿Dónde está el centro?</p>
            <p className="text-xs text-muted-foreground">Las medidas de <strong>posición</strong> nos dicen alrededor de qué valor se concentran los datos.</p>
          </CardContent>
        </Card>
        <Card className="border-l-4 border-l-amber-500 bg-amber-50/50">
          <CardContent className="p-4 space-y-1">
            <p className="font-bold text-amber-800 flex items-center gap-2"><ArrowLeftRight className="h-5 w-5" /> ¿Cuánto se dispersan?</p>
            <p className="text-xs text-muted-foreground">Las medidas de <strong>dispersión</strong> nos dicen si los datos están juntos o desperdigados.</p>
          </CardContent>
        </Card>
        <Card className="border-l-4 border-l-violet-500 bg-violet-50/50">
          <CardContent className="p-4 space-y-1">
            <p className="font-bold text-violet-800 flex items-center gap-2"><Shapes className="h-5 w-5" /> ¿Qué forma tienen?</p>
            <p className="text-xs text-muted-foreground">Las medidas de <strong>forma</strong> nos dicen si la distribución es simétrica, estirada o achatada.</p>
          </CardContent>
        </Card>
      </div>
        ...
        <div className="z-10 -mx-4 sm:-mx-6 px-4 sm:px-6 pt-4 sm:pt-6 pb-2 bg-background border-b shadow-sm" style={{ position: 'sticky', top: '-1rem' }}>
          <div className="overflow-x-auto scrollbar-hide">
            <TabsList className="inline-flex w-max sm:w-full h-auto gap-1">
              <TabsTrigger value="posicion" className="text-xs px-3 shrink-0">Posición</TabsTrigger>
              <TabsTrigger value="dispersion" className="text-xs px-3 shrink-0">Dispersión</TabsTrigger>
              <TabsTrigger value="forma" className="text-xs px-3 shrink-0">Forma</TabsTrigger>
              <TabsTrigger value="momentos" className="text-xs px-3 shrink-0">Momentos</TabsTrigger>
            </TabsList>
          </div>
        </div>
        ...
        <TabsContent value="posicion" className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-6">
                  ...
                  <Card className="border-l-4 border-l-blue-400">
                    <CardContent className="p-4 space-y-2">
                      <div className="flex items-center gap-2 flex-wrap">
                        <Badge className="bg-blue-100 text-blue-800">Definición</Badge>
                        <InlineMath math="\bar{x}" />
                      </div>
                      <FormulaDisplay math="\bar{x} = \frac{\displaystyle\sum_{i=1}^{k} x_i \cdot n_i}{n}" />
                      <p className="text-xs text-blue-700 bg-blue-50 rounded p-2 mt-1"><strong>En simple:</strong> multiplica cada valor por las veces que aparece, suma todo, y divide entre el total de datos. Es como <strong>juntar todo el dinero y repartirlo por igual</strong>.</p>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardContent className="p-4 space-y-2">
                      <Badge className="bg-blue-100 text-blue-800">Características</Badge>
                      <div className="space-y-1.5 text-xs">
                        <div className="flex items-start gap-2">
                          <Badge variant="outline" className="text-[9px] bg-green-50 text-green-700 shrink-0">Ventaja</Badge>
                          <span className="text-muted-foreground">Usa todos los datos, cálculo sencillo, es única</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <Badge variant="outline" className="text-[9px] bg-red-50 text-red-700 shrink-0">Cuidado</Badge>
              ...
              <div className="space-y-3">
                <h3 className="font-semibold text-sm flex items-center gap-2">
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-blue-100 text-blue-700 text-xs font-bold">2</span>
                  Mediana
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <Card className="border-l-4 border-l-blue-400">
                    <CardContent className="p-4 space-y-2">
                      ...
                      <p className="text-xs text-blue-700 bg-blue-50 rounded p-2 mt-1"><strong>En simple:</strong> ordena todos los datos de menor a mayor y <strong>coge el que queda justo en la mitad</strong>. Para saber cuál es, suma 1 al total de datos y divide entre 2.</p>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardContent className="p-4 space-y-2">
                      <Badge className="bg-blue-100 text-blue-800">¿Cómo se calcula?</Badge>
                      <div className="space-y-2 text-xs text-muted-foreground">
                        <div className="bg-blue-50 rounded p-2">
                          <p className="font-semibold text-blue-800">Si <InlineMath math="n" /> es impar:</p>
                          <p>La posición es un entero → la mediana es ese dato directamente.</p>
                          <p className="text-[10px] mt-1">Ej: datos <InlineMath math="0, 1, 3, 3, 5" /> → posición <InlineMath math="\frac{5+1}{2} = 3" /> → <InlineMath math="Me = 3" /></p>
                        </div>
                        <div className="bg-indigo-50 rounded p-2">
                          <p className="font-semibold text-indigo-800">Si <InlineMath math="n" /> es par:</p>
                          <p>La posición no es entera → media de los dos valores centrales.</p>
                          <p className="text-[10px] mt-1">Ej: datos <InlineMath math="1, 2, 5, 7, 9, 10" /> → posición <InlineMath math="3{,}5" /> → <InlineMath math="Me = \frac{5+7}{2} = 6" /></p>
                        </div>
                      </div>
                      <div className="flex gap-2 mt-1 flex-wrap">
                        <Badge variant="outline" className="text-[9px] bg-green-50 text-green-700">No le afectan los extremos</Badge>
                        <Badge variant="outline" className="text-[9px] bg-red-50 text-red-700">No usa todos los datos</Badge>
                      </div>
                    </CardContent>
                  </Card>
                </div>
              ...
              <div className="space-y-3">
                ...
                <Card className="border-l-4 border-l-blue-400">
                  <CardContent className="p-4 space-y-2">
                    ...
                    <div className="flex gap-2 mt-1 flex-wrap">
                      <Badge variant="outline" className="text-[9px] bg-green-50 text-green-700">Sirve para variables cualitativas</Badge>
                      <Badge variant="outline" className="text-[9px] bg-green-50 text-green-700">No le afectan los atípicos</Badge>
                      <Badge variant="outline" className="text-[9px] bg-red-50 text-red-700">No usa todos los datos</Badge>
                    </div>
                  </CardContent>
                </Card>
              ...
              <Card className="bg-amber-50 border-amber-200">
                <CardContent className="p-4 space-y-2">
                  <p className="font-semibold text-xs text-amber-800">Cuidado con los outliers</p>
                  <p className="text-xs text-muted-foreground">
              ...
              <div className="space-y-3">
                <h3 className="font-semibold text-sm flex items-center gap-2">
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-blue-100 text-blue-700 text-xs font-bold">4</span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <Card>
                    <CardContent className="p-4 space-y-2">
                      <Badge className="bg-blue-100 text-blue-800">Cuartiles</Badge>
                      <p className="text-xs text-muted-foreground">Dividen los datos en <strong>4 partes</strong> iguales.</p>
                      ...
                      <p className="text-[10px] text-muted-foreground mt-1">Multiplica el número del cuartil (1, 2 o 3) por (total de datos + 1) y divide entre 4. Eso te dice en qué posición está.</p>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardContent className="p-4 space-y-2">
                      <Badge className="bg-blue-100 text-blue-800">Deciles</Badge>
                      <p className="text-xs text-muted-foreground">Dividen los datos en <strong>10 partes</strong> iguales.</p>
                      <div className="space-y-1 text-[10px]">
                      ...
                      <p className="text-[10px] text-muted-foreground mt-1">Mismo truco: multiplica el número del decil por (total + 1) y divide entre 10.</p>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardContent className="p-4 space-y-2">
                      <Badge className="bg-blue-100 text-blue-800">Percentiles</Badge>
                      <p className="text-xs text-muted-foreground">Dividen los datos en <strong>100 partes</strong> iguales.</p>
                      <div className="space-y-1 text-[10px]">
                      ...
                      <p className="text-[10px] text-muted-foreground mt-1">El número del percentil por (total + 1) entre 100. Siempre la misma idea.</p>
                    </CardContent>
                  </Card>
                </div>
        ...
        <TabsContent value="dispersion" className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                <h3 className="font-semibold text-sm flex items-center gap-2">
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-amber-100 text-amber-700 text-xs font-bold">1</span>
                  Recorridos
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <Card>
                    <CardContent className="p-4 space-y-2">
                      <div className="flex items-center gap-2 flex-wrap">
                        <Badge className="bg-amber-100 text-amber-800">Recorrido</Badge>
                        <InlineMath math="Re" />
                      </div>
                      <FormulaDisplay math="Re = x_{\max} - x_{\min}" />
                      <p className="text-xs text-amber-700 bg-amber-50 rounded p-2 mt-1"><strong>En simple:</strong> coge el dato más grande, réstale el más pequeño. Ya está. Es la medida más fácil, pero si hay un dato raro lo estropea todo.</p>
                      <div className="flex gap-2 flex-wrap">
                        <Badge variant="outline" className="text-[9px] bg-green-50 text-green-700">Rápido y sencillo</Badge>
                        <Badge variant="outline" className="text-[9px] bg-red-50 text-red-700">Solo depende de 2 valores</Badge>
                      </div>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardContent className="p-4 space-y-2">
                      <div className="flex items-center gap-2 flex-wrap">
                        <Badge className="bg-amber-100 text-amber-800">Rango Intercuartílico</Badge>
                        <InlineMath math="RIC" />
                      </div>
                      <FormulaDisplay math="RIC = Q_3 - Q_1" />
                      <p className="text-xs text-amber-700 bg-amber-50 rounded p-2 mt-1"><strong>En simple:</strong> réstale al cuartil 3 el cuartil 1. Te dice <strong>cuánto abarca el 50% central</strong> de los datos, ignorando el 25% más bajo y el 25% más alto.</p>
                      <div className="flex gap-2 flex-wrap">
                        <Badge variant="outline" className="text-[9px] bg-green-50 text-green-700">No afectado por atípicos</Badge>
                        <Badge variant="outline" className="text-[9px] bg-green-50 text-green-700">Mide el 50% central</Badge>
                      </div>
                    </CardContent>
                  </Card>
                </div>
              ...
              <div className="space-y-3">
                <h3 className="font-semibold text-sm flex items-center gap-2">
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-amber-100 text-amber-700 text-xs font-bold">2</span>
                  Desviaciones Medias
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <Card>
                    <CardContent className="p-4 space-y-2">
                      <Badge className="bg-amber-100 text-amber-800">Respecto a la media</Badge>
                      <FormulaDisplay math="D_{\bar{x}} = \frac{1}{n} \sum_{i=1}^{k} |x_i - \bar{x}| \cdot n_i" />
                      <p className="text-xs text-amber-700 bg-amber-50 rounded p-2 mt-1"><strong>En simple:</strong> para cada dato, calcula <strong>cuánto se aleja de la media</strong> (sin signo negativo). Luego haz la media de todas esas distancias.</p>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardContent className="p-4 space-y-2">
                      <Badge className="bg-amber-100 text-amber-800">Respecto a la mediana</Badge>
                      <FormulaDisplay math="D_{Me} = \frac{1}{n} \sum_{i=1}^{k} |x_i - Me| \cdot n_i" />
                      <p className="text-xs text-amber-700 bg-amber-50 rounded p-2 mt-1"><strong>En simple:</strong> lo mismo pero midiendo la distancia a la <strong>mediana</strong> en vez de a la media.</p>
                    </CardContent>
                  </Card>
                </div>
                <Card className="bg-amber-50 border-amber-200">
              ...
              <div className="space-y-3">
                <h3 className="font-semibold text-sm flex items-center gap-2">
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-amber-100 text-amber-700 text-xs font-bold">3</span>
                  Varianza y Desviación Típica
                </h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <Card className="border-l-4 border-l-amber-400">
                    <CardContent className="p-4 space-y-2">
                      <div className="flex items-center gap-2 flex-wrap">
                        <Badge className="bg-amber-100 text-amber-800">Varianza</Badge>
                        <InlineMath math="s^2" />
                      </div>
                      <FormulaDisplay math="s^2 = \frac{1}{n}\sum_{i=1}^{k} (x_i - \bar{x})^2 \cdot n_i" />
                      <p className="text-xs text-amber-700 bg-amber-50 rounded p-2 mt-1"><strong>En simple:</strong> 1) a cada dato le <strong>restas la media</strong>, 2) <strong>elevas al cuadrado</strong> esa diferencia, 3) haces <strong>la media</strong> de todos esos cuadrados. Cuanto mayor sea, más dispersos están los datos.</p>
                      <Card className="bg-gray-50 border-gray-200">
                        <CardContent className="p-2 text-[10px] space-y-1">
                      ...
                      <Badge variant="outline" className="text-[9px] bg-orange-50 text-orange-700">Está en unidades al cuadrado (€², kg²...)</Badge>
                    </CardContent>
                  </Card>
                  <Card className="border-l-4 border-l-amber-400">
                    <CardContent className="p-4 space-y-2">
                      <div className="flex items-center gap-2 flex-wrap">
                        <Badge className="bg-amber-100 text-amber-800">Desviación Típica</Badge>
                        <InlineMath math="s" />
                      </div>
                      <FormulaDisplay math="s = +\sqrt{s^2}" />
                      <p className="text-xs text-amber-700 bg-amber-50 rounded p-2 mt-1"><strong>En simple:</strong> es la <strong>raíz cuadrada de la varianza</strong>. Como la varianza está en unidades al cuadrado (€², cm²...), le sacamos la raíz para que vuelva a estar en € o cm. Es la medida de dispersión más usada.</p>
                      <div className="flex gap-2 flex-wrap">
                        <Badge variant="outline" className="text-[9px] bg-green-50 text-green-700">Mismas unidades que los datos</Badge>
                        <Badge variant="outline" className="text-[9px] bg-green-50 text-green-700">Usa todos los datos</Badge>
                      </div>
                    </CardContent>
                  </Card>
                </div>
                ...
                <Card className="bg-gray-50 border-gray-200">
                  <CardContent className="p-4 space-y-2">
                    <p className="font-semibold text-xs">Propiedades de la varianza ante transformaciones lineales</p>
                      ...
                      <CardContent className="p-3 text-xs space-y-2">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-center text-[10px]">
                          <div className="bg-white rounded p-2">
                            ...
                            <p className="font-semibold text-amber-700"><InlineMath math="CV = 43{,}5\%" /></p>
                          </div>
                          <div className="bg-white rounded p-2">
                            <p className="font-bold">Empresa Y</p>
                            <p><InlineMath math="\bar{x}=3" />, <InlineMath math="s=1{,}6" /></p>
                            <p className="font-semibold text-amber-700"><InlineMath math="CV = 53{,}3\%" /></p>
                          </div>
                          <div className="bg-white rounded p-2">
                            <p className="font-bold">Empresa Z</p>
                            <p><InlineMath math="\bar{x}=3{,}6" />, <InlineMath math="s=5" /></p>
                            <p className="font-semibold text-red-700"><InlineMath math="CV = 138{,}9\%" /></p>
                          </div>
                        </div>
                        <p className="text-[10px] text-muted-foreground">La empresa X tiene la media más representativa (menor CV). La Z tiene un CV altísimo: su media no es fiable.</p>
                      </CardContent>
                    </Card>

                    <div className="flex gap-2 flex-wrap">
                      <Badge variant="outline" className="text-[9px] bg-green-50 text-green-700">Adimensional: compara escalas distintas</Badge>
                      <Badge variant="outline" className="text-[9px] bg-red-50 text-red-700">No se puede usar si la media es 0</Badge>
                    </div>
                  </CardContent>
                </Card>
              </div>
              ...
              <div className="space-y-3">
                <h3 className="font-semibold text-sm flex items-center gap-2">
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-amber-100 text-amber-700 text-xs font-bold">5</span>
                  Tipificación (Estandarización)
                </h3>
                <Card className="border-l-4 border-l-amber-400">
                  <CardContent className="p-4 space-y-2">
                    <div className="flex items-center gap-2 flex-wrap">
                      <Badge className="bg-amber-100 text-amber-800">Variable Tipificada</Badge>
                      <InlineMath math="Z" />
                    </div>
                    <FormulaDisplay math="Z = \frac{X - \bar{x}}{s}" />
                    <p className="text-xs text-amber-700 bg-amber-50 rounded p-2 mt-1"><strong>En simple:</strong> coge tu dato, <strong>réstale la media</strong> y <strong>divide entre la desviación típica</strong>. El resultado te dice <strong>a cuántas desviaciones típicas está de la media</strong>. Sirve para comparar datos de escalas totalmente diferentes (notas de Mates vs Historia, sueldos de distintas empresas...).</p>

                    <Card className="bg-amber-50 border-amber-200">
                      <CardContent className="p-3 text-xs space-y-2">
                        <p className="font-semibold text-amber-800">Ejemplo: ¿en qué asignatura destaca más?</p>
                        <p className="text-muted-foreground">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                          <Card className="bg-blue-50 border-blue-200">
                            <CardContent className="p-2 text-center">
                              <p className="text-[10px] text-muted-foreground">Mates</p>
                              <FormulaDisplay math="Z = \frac{8-6}{1} = 2" />
                            </CardContent>
                          </Card>
                          <Card className="bg-violet-50 border-violet-200">
                            <CardContent className="p-2 text-center">
                              <p className="text-[10px] text-muted-foreground">Historia</p>
        ...
        <TabsContent value="forma" className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                <h3 className="font-semibold text-sm flex items-center gap-2">
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-violet-100 text-violet-700 text-xs font-bold">1</span>
                  Asimetría
                </h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-center text-xs">
                  <Card className="bg-red-50 border-red-200">
                    <CardContent className="p-3 space-y-1">
                      <p className="font-bold text-red-800">Asimetría negativa</p>
                      <p className="text-[10px] text-muted-foreground">Cola larga a la izquierda</p>
                      <FormulaDisplay math="\bar{x} \leq Me \leq Mo" />
                      <p className="text-[10px]">La media se &quot;arrastra&quot; hacia los valores bajos</p>
                    </CardContent>
                  </Card>
                  <Card className="bg-green-50 border-green-200">
                    <CardContent className="p-3 space-y-1">
                      <p className="font-bold text-green-800">Simétrica</p>
                      <p className="text-[10px] text-muted-foreground">Equilibrada</p>
                      <FormulaDisplay math="Me = Mo = \bar{x}" />
                      <p className="text-[10px]">Las tres medidas coinciden</p>
                    </CardContent>
                  </Card>
                  <Card className="bg-blue-50 border-blue-200">
                    <CardContent className="p-3 space-y-1">
                      <p className="font-bold text-blue-800">Asimetría positiva</p>
                      <p className="text-[10px] text-muted-foreground">Cola larga a la derecha</p>
                      <FormulaDisplay math="Mo \leq Me \leq \bar{x}" />
                      <p className="text-[10px]">La media se &quot;arrastra&quot; hacia los valores altos</p>
                    </CardContent>
                  </Card>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <Card>
                    <CardContent className="p-4 space-y-2">
                      <div className="flex items-center gap-2 flex-wrap">
                        <Badge className="bg-violet-100 text-violet-800">Asimetría de Pearson</Badge>
                        <InlineMath math="g_P" />
                      </div>
                      <FormulaDisplay math="g_P = \frac{\bar{x} - Mo}{s}" />
                      <p className="text-xs text-violet-700 bg-violet-50 rounded p-2 mt-1"><strong>En simple:</strong> réstale la moda a la media y divide entre la desviación típica. Si la media y la moda son iguales → simétrica. Si la media es <strong>mayor</strong> que la moda → cola a la derecha (la media se &quot;arrastra&quot; hacia los valores altos).</p>
                      <Card className="bg-violet-50 border-violet-200 mt-2">
                        <CardContent className="p-3 text-xs space-y-1">
                          <p className="font-semibold text-violet-800">Ejemplo: 3 navieras</p>
              ...
              <div className="space-y-3">
                <h3 className="font-semibold text-sm flex items-center gap-2">
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-violet-100 text-violet-700 text-xs font-bold">2</span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-center text-xs">
                  <Card className="bg-orange-50 border-orange-200">
                    <CardContent className="p-3 space-y-1">
                      <p className="font-bold text-orange-800">Platicúrtica</p>
                      <p className="font-bold"><InlineMath math="g_2 < 0" /></p>
                      <p className="text-[10px] text-muted-foreground">Más <strong>achatada</strong> que la Normal. Datos más repartidos, menos concentrados en el centro.</p>
                    </CardContent>
                  </Card>
                  <Card className="bg-green-50 border-green-200">
                    <CardContent className="p-3 space-y-1">
                      <p className="font-bold text-green-800">Mesocúrtica</p>
                      <p className="font-bold"><InlineMath math="g_2 = 0" /></p>
                      <p className="text-[10px] text-muted-foreground">Igual que la Normal. Es la referencia estándar.</p>
                    </CardContent>
                  </Card>
                  <Card className="bg-violet-50 border-violet-200">
                    <CardContent className="p-3 space-y-1">
                      <p className="font-bold text-violet-800">Leptocúrtica</p>
                      <p className="font-bold"><InlineMath math="g_2 > 0" /></p>
                      <p className="text-[10px] text-muted-foreground">Más <strong>puntiaguda</strong> que la Normal. Datos muy concentrados en el centro, con colas más largas.</p>
                    </CardContent>
                  </Card>
                </div>
              </div>
        ...
        <TabsContent value="momentos" className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Card className="border-l-4 border-l-teal-400">
                  <CardContent className="p-4 space-y-3">
                    <Badge className="bg-teal-100 text-teal-800">Momentos respecto al origen</Badge>
                    <p className="text-xs text-muted-foreground">También llamados <strong>no centrales</strong>. Se calculan respecto al cero:</p>
                    <FormulaDisplay math="a_r = \frac{1}{n}\sum_{i=1}^{k} x_i^r \cdot n_i" />
                    <div className="bg-teal-100/60 border border-teal-200 rounded-lg p-2.5 text-xs text-teal-900">
                    ...
                    <div className="space-y-1.5 text-[10px] bg-teal-50 rounded p-3">
                      <p className="font-semibold text-teal-800">Casos particulares:</p>
                ...
                <Card className="border-l-4 border-l-cyan-400">
                  <CardContent className="p-4 space-y-3">
                    <Badge className="bg-cyan-100 text-cyan-800">Momentos centrales</Badge>
                    <p className="text-xs text-muted-foreground">Se calculan respecto a la <strong>media aritmética</strong>:</p>
                    <FormulaDisplay math="m_r = \frac{1}{n}\sum_{i=1}^{k} (x_i - \bar{x})^r \cdot n_i" />
                    <div className="bg-cyan-100/60 border border-cyan-200 rounded-lg p-2.5 text-xs text-cyan-900">
                    ...
                    <div className="space-y-1.5 text-[10px] bg-cyan-50 rounded p-3">
                      <p className="font-semibold text-cyan-800">Casos particulares:</p>
                      <div className="space-y-1">
              ...
              <Card className="bg-gradient-to-r from-teal-50 to-cyan-50 border-2">
                <CardContent className="p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                    <div className="bg-white rounded p-2 space-y-1">
                      ...
                      <p className="text-[10px] text-teal-800 bg-teal-50 rounded px-2 py-1"><span className="font-semibold">En simple:</span> la varianza es el momento central de orden 2. También se puede calcular como la media de los cuadrados menos el cuadrado de la media.</p>
                    </div>
                    <div className="bg-white rounded p-2 space-y-1">
                      <p className="font-semibold">Asimetría de Fisher</p>
                      <FormulaDisplay math="g_1 = \frac{m_3}{s^3} = \frac{m_3}{m_2^{3/2}}" />
                      <p className="text-[10px] text-teal-800 bg-teal-50 rounded px-2 py-1"><span className="font-semibold">En simple:</span> coge el momento central de orden 3 y divídelo entre la desviación típica al cubo. Así normalizas la asimetría.</p>
                    </div>
                    <div className="bg-white rounded p-2 space-y-1">
                      <p className="font-semibold">Curtosis</p>
                      <FormulaDisplay math="g_2 = \frac{m_4}{s^4} - 3 = \frac{m_4}{m_2^2} - 3" />
                      <p className="text-[10px] text-teal-800 bg-teal-50 rounded px-2 py-1"><span className="font-semibold">En simple:</span> coge el momento central de orden 4, divídelo entre la varianza al cuadrado, y réstale 3 (para que la Normal dé cero).</p>
                    </div>
                    <div className="bg-white rounded p-2 space-y-1">
      ...
      {/* ===== RESUMEN VISUAL ===== */}
      <Card className="bg-gradient-to-r from-blue-50 via-amber-50 to-violet-50 border-2">
        <CardContent className="p-4">
          <p className="font-semibold text-sm text-center mb-3">En resumen: 3 preguntas, 3 grupos de medidas</p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
            <div className="space-y-1">
              <p className="font-bold text-blue-800">Posición</p>
            ...
            <div className="space-y-1">
              <p className="font-bold text-amber-800">Dispersión</p>
            ...
            <div className="space-y-1">
              <p className="font-bold text-violet-800">Forma</p>
            ...
            <Card className="hover:shadow-md transition-all hover:scale-[1.01] cursor-pointer">
              <CardContent className="flex items-center justify-between py-3 sm:py-4 px-4 sm:px-5">
                <div className="flex items-center gap-3 min-w-0">
                  <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-violet-100 text-violet-700 text-sm font-bold">
                    {ej.num}
                  </span>
                  <div className="min-w-0">
                    ...
                    <div className="flex items-center gap-1 mt-1">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {ej.sections.map((s) => (
                          <Badge key={s} variant="outline" className="text-[10px] px-1.5 py-0 h-4 font-normal text-violet-700 border-violet-200">
                            {s}
                          </Badge>
                        ))}
                      </div>
