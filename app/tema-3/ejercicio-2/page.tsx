    ...
    >
      ...
      <StepCard stepNumber={1} title="¿Qué vamos a aprender en este ejercicio?" variant="explanation">
        ...
        <Card className="bg-amber-50 dark:bg-amber-950/20 border-amber-200 dark:border-amber-800 mt-2">
          <CardContent className="p-3 text-sm space-y-2">
            <p className="font-semibold text-amber-800 dark:text-amber-200">La gran pregunta: &quot;¿Cuál es el valor típico de estos datos?&quot;</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 mt-1">
              <div className="bg-white dark:bg-gray-900 rounded p-2">
                <p className="font-semibold text-blue-700 dark:text-blue-300">Media</p>
                <p className="text-sm text-muted-foreground">&quot;El promedio de todos los lanzamientos&quot;</p>
              </div>
              <div className="bg-white dark:bg-gray-900 rounded p-2">
                <p className="font-semibold text-emerald-700 dark:text-emerald-300">Mediana</p>
                <p className="text-sm text-muted-foreground">&quot;El valor que queda justo en el centro&quot;</p>
              </div>
              <div className="bg-white dark:bg-gray-900 rounded p-2">
                <p className="font-semibold text-violet-700 dark:text-violet-300">Moda</p>
                <p className="text-sm text-muted-foreground">&quot;El valor que más veces ha salido&quot;</p>
              </div>
            </div>
      ...
      <StepCard stepNumber={4} title="c) Media aritmética" variant="calculation">
        <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800 mb-3">
          <CardContent className="p-3 text-sm space-y-2">
            <p className="font-semibold text-blue-800 dark:text-blue-200">¿Qué es la media aritmética?</p>
            <p className="text-muted-foreground">
            ...
            <p className="font-semibold text-blue-800 dark:text-blue-200">La fórmula, paso a paso:</p>
      ...
      <StepCard stepNumber={5} title="c) Mediana" variant="calculation">
        <Card className="bg-emerald-50 dark:bg-emerald-950/20 border-emerald-200 dark:border-emerald-800 mb-3">
          <CardContent className="p-3 text-sm space-y-2">
            <p className="font-semibold text-emerald-800 dark:text-emerald-200">¿Qué es la mediana?</p>
            <p className="text-muted-foreground">
            ...
            <p className="font-semibold text-emerald-800 dark:text-emerald-200">¿Cómo se calcula?</p>
            <div className="bg-white dark:bg-gray-900 rounded p-2 space-y-1">
        ...
        <p className="text-sm font-mono bg-gray-50 dark:bg-gray-800 p-2 rounded mb-2">
          {sorted.map((v, i) => (
            <span key={i}>
              {i === 9 || i === 10 ? <strong className="text-emerald-700 dark:text-emerald-300 bg-emerald-100 dark:bg-emerald-900/30 px-0.5 rounded">{v}</strong> : v}
              {i < sorted.length - 1 ? ", " : ""}
            </span>
          ))}
        </p>
      ...
      <StepCard stepNumber={6} title="c) Moda" variant="calculation">
        <Card className="bg-violet-50 dark:bg-violet-950/20 border-violet-200 dark:border-violet-800 mb-3">
          <CardContent className="p-3 text-sm space-y-2">
            <p className="font-semibold text-violet-800 dark:text-violet-200">¿Qué es la moda?</p>
            <p className="text-muted-foreground">
            ...
            <p className="font-semibold text-violet-800 dark:text-violet-200">¿Cómo se encuentra?</p>
            <div className="bg-white dark:bg-gray-900 rounded p-2 space-y-1">
        ...
        <div className="space-y-1 mt-2">
          {freqTable.map((r) => (
            <div key={r.xi} className={`flex items-center gap-2 px-3 py-1.5 rounded text-sm ${r.xNum === mod[0] ? "bg-violet-100 dark:bg-violet-900/30 border-violet-300 border font-semibold" : "bg-gray-50 dark:bg-gray-800"}`}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800">
            <CardContent className="p-3 space-y-1">
              <p className="font-semibold text-sm text-blue-800 dark:text-blue-200">Media = {round(m, 2)}</p>
              <p className="text-sm text-muted-foreground"><strong>¿Qué responde?</strong> &quot;¿Cuál es el promedio de los resultados?&quot;</p>
              <p className="text-sm text-muted-foreground"><strong>Ventaja:</strong> Usa todos los datos.</p>
              <p className="text-sm text-muted-foreground"><strong>Desventaja:</strong> Sensible a valores extremos.</p>
            </CardContent>
          </Card>
          <Card className="bg-emerald-50 dark:bg-emerald-950/20 border-emerald-200 dark:border-emerald-800">
            <CardContent className="p-3 space-y-1">
              <p className="font-semibold text-sm text-emerald-800 dark:text-emerald-200">Mediana = {med}</p>
              <p className="text-sm text-muted-foreground"><strong>¿Qué responde?</strong> &quot;¿Cuál es el valor central?&quot;</p>
              <p className="text-sm text-muted-foreground"><strong>Ventaja:</strong> No le afectan valores extremos.</p>
              <p className="text-sm text-muted-foreground"><strong>Desventaja:</strong> No usa la magnitud de todos los datos.</p>
            </CardContent>
          </Card>
          <Card className="bg-violet-50 dark:bg-violet-950/20 border-violet-200 dark:border-violet-800">
            <CardContent className="p-3 space-y-1">
              <p className="font-semibold text-sm text-violet-800 dark:text-violet-200">Moda = {mod.join(", ")}</p>
              <p className="text-sm text-muted-foreground"><strong>¿Qué responde?</strong> &quot;¿Cuál es el más frecuente?&quot;</p>
              <p className="text-sm text-muted-foreground"><strong>Ventaja:</strong> Funciona con cualquier tipo de variable.</p>
              <p className="text-sm text-muted-foreground"><strong>Desventaja:</strong> Puede no existir o no ser única.</p>
            </CardContent>
          </Card>
        </div>
